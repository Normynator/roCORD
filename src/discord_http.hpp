...
//  long long int reset;
   ...
   * This queue contains a request object which hold all data to perform the request.
   */
  boost::lockfree::spsc_queue<http_request, boost::lockfree::capacity<1024>> spsc_queue;
